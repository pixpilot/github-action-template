...
export const error: jest.MockedFunction<(message: string | Error) => void> =
  jest.fn()
export const info: jest.MockedFunction<(message: string) => void> = jest.fn()
export const getInput: jest.MockedFunction<
  (name: string, options?: object) => string
> = jest.fn()
...
export const setFailed: jest.MockedFunction<(message: string | Error) => void> =
  jest.fn()
export const warning: jest.MockedFunction<(message: string | Error) => void> =
  jest.fn()
